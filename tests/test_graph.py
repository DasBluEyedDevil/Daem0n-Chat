        ...
        Create a diamond graph:
          ...
          B   C
           \\ /
            D
        """
        mem_a = await memory_manager.remember(category="decision", content="A", user_id="/test")
        mem_b = await memory_manager.remember(category="pattern", content="B", user_id="/test")
        mem_c = await memory_manager.remember(category="pattern", content="C", user_id="/test")
        mem_d = await memory_manager.remember(category="learning", content="D", user_id="/test")
