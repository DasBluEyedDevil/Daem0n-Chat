...
class TestPreflightToken:
    ...
    def test_token_verification(self):
        ...
        verified = PreflightToken.verify(serialized, user_id="/test")
    ...
    def test_token_tamper_detection(self):
        ...
        verified = PreflightToken.verify(tampered, user_id="/test")
...
class TestPreflightTokenIntegration:
    ...
    async def test_context_check_returns_preflight_token(self, db_manager):
        ...
        ctx = await server.get_user_context(user_id)
        ...
        token = PreflightToken.verify(result["preflight_token"], user_id)
