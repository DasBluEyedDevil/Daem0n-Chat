...
try:
    ...
    from ..context_manager import (
        ...
        _missing_user_id_error, _check_covenant_counsel,
...
async def remember(
    ...
    effective_path = user_id or _default_user_id
...
async def recall_for_file(
    ...
    ctx = await get_user_context(user_id)
    return await ctx.memory_manager.recall_for_file(file_path=file_path, limit=limit, user_id=ctx.user_id)
