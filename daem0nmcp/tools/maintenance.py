...
async def import_data(
    ...
    async with ctx.db_manager.get_session() as session:
        ...
        for mem_data in data.get("memories", []):
            ...
            # Normalize file_path if present and user_id is available
            try:
            ...
            if file_path_abs and ctx.user_id:
                file_path_abs, file_path_rel = _normalize_file_path(file_path_abs, ctx.user_id)
